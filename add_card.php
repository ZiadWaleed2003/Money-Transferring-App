                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <div class="owl-carousel testimonial-carousel">
                                <div class="testimonial-item text-center">
                                    <img class="img-fluid rounded-circle mx-auto mb-4" src="img/commercial-international-bank-cib-vector-logo-small.png" style="width: 100px; height: 100px;">
                                    <h5 class="mb-1">CIB</h5>
                                    <p>Commercial International Bank Egypt</p>
                                </div>
                                <div class="testimonial-item text-center">
                                    <img class="img-fluid rounded-circle mx-auto mb-4" src="img/qnb.ai-converted.png" style="width: 100px; height: 100px;">
                                    <h5 class="mb-1">QNB</h5>
                                    <p>Qatar National Bank</p>
                                </div>
                                <div class="testimonial-item text-center">
                                    <img class="img-fluid rounded-circle mx-auto mb-4" src="img/Banque_misr.jpg" style="width: 100px; height: 100px;">
