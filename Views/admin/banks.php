    ...
    <div class="row bg-secondary rounded align-items-center justify-content-center mx-0 p-5">
        ...
        <div class="col-12 text-center pb-5">
            <span id="links-tracking">
                ...
                /
                &nbsp;
                <a href="banks.php" class="h5 text-primary">Banks</a>
            ...
            <div class="home-page">
                <div class="row g-4 mb-4 justify-content-center align-items-center">
                    <div class="col-sm-6 col-xl-3">
                        <a id="check-balance" class="options" href="show-banks.php">
                            <div class="bg-dark flex-column align-items-center justify-content-center p-4">
                                <h3 class="m-0 text-center p-2">Show Banks</h3>
                            </div>
                        </a>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                        <a id="check-balance" class="options" href="add-banks.php">
                            <div class="bg-dark flex-column align-items-center justify-content-center p-4">
                                <h3 class="m-0 text-center p-2">Add Banks</h3>
                            </div>
                        </a>
                    </div>
                </div>
