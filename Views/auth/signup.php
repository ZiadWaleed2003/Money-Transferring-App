                ...
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <form action="../../controllers/SignUpController.php" method="post"
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingText" placeholder="1234567890"
                                    name="phone" required>
                                <label for="floatingText">Phone Number</label>
                            </div>
                            <!-- File input for image -->
                            <div class="mb-3">
                                <label for="image" class="form-label">FaceID Image*</label>
                                <input class="form-control mb-2" type="file" id="image" name="image">
                                <small class=" text-muted">*: This image will only be used for login purposes. For a
                                    profile
                                    image
                                    upload after signup</small>
                            </div>
